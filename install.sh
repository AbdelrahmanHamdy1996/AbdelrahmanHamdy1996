{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "machine_shape": "hm",
      "mount_file_id": "1yPmwNzgQbVQ-Io7nLxz62qrLsNV-LzlH",
      "authorship_tag": "ABX9TyP5JJkhAU0BtfNpgl6wAxPR",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/AbdelrahmanHamdy1996/AbdelrahmanHamdy1996/blob/master/install.sh\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        ...
        "id": "9V4XgvjQ8U_T",
        "outputId": "643ea182-dc0d-425d-a988-ce1f5cf30e82"
      },
      "source": [
        "# install libraries\n",
        "!chmod +x install.sh\n",
        "!sudo ./install.sh #file in drive "
      ],
      "execution_count": 9,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Making all in src\n",
            "make[1]: Entering directory '/content/drive/MyDrive/ta-lib/src'\n",
            "Making all in ta_abstract\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src/ta_abstract'\n",
            ...
            "(cd .libs && rm -f libta_abstract.la && cp -p ../libta_abstract.la libta_abstract.la)\n",
            ...
            "(cd .libs && rm -f libta_abstract_gc.la && cp -p ../libta_abstract_gc.la libta_abstract_gc.la)\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/ta_abstract'\n",
            "Making all in ta_common\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src/ta_common'\n",
            ...
            "(cd .libs && rm -f libta_common.la && cp -p ../libta_common.la libta_common.la)\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/ta_common'\n",
            "Making all in ta_func\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src/ta_func'\n",
            ...
            "(cd .libs && rm -f libta_func.la && cp -p ../libta_func.la libta_func.la)\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/ta_func'\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src'\n",
            ...
            "(cd .libs && rm -f libta_lib.so.0 && cp -p libta_lib.so.0.0.0 libta_lib.so.0)\n",
            "(cd .libs && rm -f libta_lib.so && cp -p libta_lib.so.0.0.0 libta_lib.so)\n",
            ...
            "mkdir .libs\n",
            "gcc -g -O2 -o gen_code gen_code-gen_code.o  -L/content/drive/MyDrive/ta-lib/src/ta_common -L/content/drive/MyDrive/ta-lib/src/ta_abstract -L/content/drive/MyDrive/ta-lib/src/ta_func /content/drive/MyDrive/ta-lib/src/ta_common/.libs/libta_common.a /content/drive/MyDrive/ta-lib/src/ta_abstract/.libs/libta_abstract_gc.a /content/drive/MyDrive/ta-lib/src/ta_func/.libs/libta_func.a -lm -lpthread -ldl\n",
            "make  gen_code\n",
            "make[3]: Entering directory '/content/drive/MyDrive/ta-lib/src/tools/gen_code'\n",
            "make[3]: 'gen_code' is up to date.\n",
            "make[3]: Leaving directory '/content/drive/MyDrive/ta-lib/src/tools/gen_code'\n",
            "cp gen_code ../../../bin\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/tools/gen_code'\n",
            "Making all in ta_regtest\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src/tools/ta_regtest'\n",
            ...
            "mkdir .libs\n",
            "gcc -g -O2 -o .libs/ta_regtest ta_regtest-ta_regtest.o ta_regtest-test_data.o ta_regtest-test_util.o ta_regtest-test_abstract.o ta_regtest-test_adx.o ta_regtest-test_mom.o ta_regtest-test_sar.o ta_regtest-test_rsi.o ta_regtest-test_candlestick.o ta_regtest-test_per_ema.o ta_regtest-test_per_hlc.o ta_regtest-test_stoch.o ta_regtest-test_macd.o ta_regtest-test_minmax.o ta_regtest-test_per_hlcv.o ta_regtest-test_1in_1out.o ta_regtest-test_1in_2out.o ta_regtest-test_per_ohlc.o ta_regtest-test_stddev.o ta_regtest-test_bbands.o ta_regtest-test_ma.o ta_regtest-test_po.o ta_regtest-test_per_hl.o ta_regtest-test_trange.o ta_regtest-test_internals.o  -L/content/drive/MyDrive/ta-lib/src /content/drive/MyDrive/ta-lib/src/.libs/libta_lib.so -lm -lpthread -ldl\n",
            "creating ta_regtest\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/tools/ta_regtest'\n",
            "make[2]: Entering directory '/content/drive/MyDrive/ta-lib/src/tools'\n",
            "make[2]: Nothing to be done for 'all-am'.\n",
            "make[2]: Leaving directory '/content/drive/MyDrive/ta-lib/src/tools'\n",
            "make[1]: Leaving directory '/content/drive/MyDrive/ta-lib/src/tools'\n",
            "make[1]: Entering directory '/content/drive/MyDrive/ta-lib'\n",
            "make[1]: Nothing to be done for 'all-am'.\n",
            "make[1]: Leaving directory '/content/drive/MyDrive/ta-lib'\n",
            "Making install in src\n",
            "make[1]: Entering directory '/content/drive/My Drive/ta-lib/src'\n",
            "Making install in ta_abstract\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_abstract'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_abstract'\n",
            ...
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_abstract'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_abstract'\n",
            "Making install in ta_common\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_common'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_common'\n",
            "make[3]: Nothing to be done for 'install-exec-am'.\n",
            "test -z \"/usr/include/ta-lib/\" || /bin/mkdir -p \"/usr/include/ta-lib/\"\n",
            " /usr/bin/install -c -m 644 '../../include/ta_defs.h' '/usr/include/ta-lib//ta_defs.h'\n",
            " /usr/bin/install -c -m 644 '../../include/ta_libc.h' '/usr/include/ta-lib//ta_libc.h'\n",
            " /usr/bin/install -c -m 644 '../../include/ta_common.h' '/usr/include/ta-lib//ta_common.h'\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_common'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_common'\n",
            "Making install in ta_func\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_func'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/ta_func'\n",
            "make[3]: Nothing to be done for 'install-exec-am'.\n",
            "test -z \"/usr/include/ta-lib/\" || /bin/mkdir -p \"/usr/include/ta-lib/\"\n",
            " /usr/bin/install -c -m 644 '../../include/ta_defs.h' '/usr/include/ta-lib//ta_defs.h'\n",
            " /usr/bin/install -c -m 644 '../../include/ta_libc.h' '/usr/include/ta-lib//ta_libc.h'\n",
            " /usr/bin/install -c -m 644 '../../include/ta_func.h' '/usr/include/ta-lib//ta_func.h'\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_func'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/ta_func'\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src'\n",
            ...
            "(cd /usr/lib && { cp -p -f libta_lib.so.0.0.0 libta_lib.so.0 || { rm -f libta_lib.so.0 && cp -p libta_lib.so.0.0.0 libta_lib.so.0; }; })\n",
            "(cd /usr/lib && { cp -p -f libta_lib.so.0.0.0 libta_lib.so || { rm -f libta_lib.so && cp -p libta_lib.so.0.0.0 libta_lib.so; }; })\n",
            ...
            "/sbin/ldconfig.real: /usr/lib/libta_lib.so.0 is not a symbolic link\n",
            "\n",
            "----------------------------------------------------------------------\n",
            ...
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src'\n",
            "make[1]: Leaving directory '/content/drive/My Drive/ta-lib/src'\n",
            "Making install in src/tools\n",
            "make[1]: Entering directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "Making install in gen_code\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "make  gen_code\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "make[3]: 'gen_code' is up to date.\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "cp gen_code ../../../bin\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "make[3]: Nothing to be done for 'install-exec-am'.\n",
            "make[3]: Nothing to be done for 'install-data-am'.\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools/gen_code'\n",
            "Making install in ta_regtest\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/tools/ta_regtest'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/tools/ta_regtest'\n",
            "make[3]: Nothing to be done for 'install-exec-am'.\n",
            "make[3]: Nothing to be done for 'install-data-am'.\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools/ta_regtest'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools/ta_regtest'\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "make[3]: Entering directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "make[3]: Nothing to be done for 'install-exec-am'.\n",
            "make[3]: Nothing to be done for 'install-data-am'.\n",
            "make[3]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "make[1]: Leaving directory '/content/drive/My Drive/ta-lib/src/tools'\n",
            "make[1]: Entering directory '/content/drive/My Drive/ta-lib'\n",
            "make[2]: Entering directory '/content/drive/My Drive/ta-lib'\n",
            "test -z \"/usr/bin\" || /bin/mkdir -p \"/usr/bin\"\n",
            " /usr/bin/install -c 'ta-lib-config' '/usr/bin/ta-lib-config'\n",
            "make[2]: Nothing to be done for 'install-data-am'.\n",
            "make[2]: Leaving directory '/content/drive/My Drive/ta-lib'\n",
            "make[1]: Leaving directory '/content/drive/My Drive/ta-lib'\n",
            "Collecting TA-Lib\n",
            ...
            "  Created wheel for TA-Lib: filename=TA_Lib-0.4.19-cp36-cp36m-linux_x86_64.whl size=1437756 sha256=2f29e6a26981a0663262053fbba6d00cbcb47c5ee16d3e4b4ac5a69e84c28453\n",
            ...
            "Requirement already satisfied: pandas in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (1.1.5)\n",
            "Requirement already satisfied: configparser in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (5.0.1)\n",
            ...
            "Requirement already satisfied: six in /usr/local/lib/python3.6/dist-packages (from socketIO-client->fxcmpy) (1.15.0)\n",
            "Requirement already satisfied: urllib3!=1.25.0,!=1.25.1,<1.26,>=1.21.1 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (1.24.3)\n",
            "Requirement already satisfied: certifi>=2017.4.17 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (2020.12.5)\n",
            "Requirement already satisfied: idna<3,>=2.5 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (2.10)\n",
            ...
            "Requirement already satisfied: python-dateutil>=2.7.3 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (2.8.1)\n",
            "Requirement already satisfied: pytz>=2017.2 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (2018.9)\n",
            "Requirement already satisfied: numpy>=1.15.4 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (1.19.5)\n",
            "Requirement already up-to-date: fxcmpy in /usr/local/lib/python3.6/dist-packages (1.2.6)\n",
            "Requirement already satisfied, skipping upgrade: socketIO-client in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (0.7.2)\n",
            "Requirement already satisfied, skipping upgrade: pandas in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (1.1.5)\n",
            "Requirement already satisfied, skipping upgrade: configparser in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (5.0.1)\n",
            "Requirement already satisfied, skipping upgrade: requests[socks] in /usr/local/lib/python3.6/dist-packages (from fxcmpy) (2.23.0)\n",
            "Requirement already satisfied, skipping upgrade: websocket-client in /usr/local/lib/python3.6/dist-packages (from socketIO-client->fxcmpy) (0.57.0)\n",
            "Requirement already satisfied, skipping upgrade: six in /usr/local/lib/python3.6/dist-packages (from socketIO-client->fxcmpy) (1.15.0)\n",
            "Requirement already satisfied, skipping upgrade: python-dateutil>=2.7.3 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (2.8.1)\n",
            "Requirement already satisfied, skipping upgrade: pytz>=2017.2 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (2018.9)\n",
            "Requirement already satisfied, skipping upgrade: numpy>=1.15.4 in /usr/local/lib/python3.6/dist-packages (from pandas->fxcmpy) (1.19.5)\n",
            "Requirement already satisfied, skipping upgrade: idna<3,>=2.5 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (2.10)\n",
            "Requirement already satisfied, skipping upgrade: urllib3!=1.25.0,!=1.25.1,<1.26,>=1.21.1 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (1.24.3)\n",
            "Requirement already satisfied, skipping upgrade: certifi>=2017.4.17 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (2020.12.5)\n",
            "Requirement already satisfied, skipping upgrade: chardet<4,>=3.0.2 in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (3.0.4)\n",
            "Requirement already satisfied, skipping upgrade: PySocks!=1.5.7,>=1.5.6; extra == \"socks\" in /usr/local/lib/python3.6/dist-packages (from requests[socks]->fxcmpy) (1.7.1)\n",
            "Requirement already satisfied: python-socketio==4.4.0 in /usr/local/lib/python3.6/dist-packages (4.4.0)\n",
            "Requirement already satisfied: six>=1.9.0 in /usr/local/lib/python3.6/dist-packages (from python-socketio==4.4.0) (1.15.0)\n",
            "Requirement already satisfied: python-engineio>=3.9.0 in /usr/local/lib/python3.6/dist-packages (from python-socketio==4.4.0) (3.9.0)\n",
            "Requirement already satisfied: python-engineio==3.9.0 in /usr/local/lib/python3.6/dist-packages (3.9.0)\n",
            "Requirement already satisfied: six>=1.9.0 in /usr/local/lib/python3.6/dist-packages (from python-engineio==3.9.0) (1.15.0)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4ZifbeiV9ZnG",
        "outputId": "1a2774f7-8ef1-4f59-a1b2-b0a91ca2a4f0"
      },
      "source": [
        "# impoert libraries\n",
        "import numpy as np \n",
      ...
      "outputs": [
        {
          ...
          "traceback": [
            ...
            "\u001b[0;32m<ipython-input-3-40a468f8eae9>\u001b[0m in \u001b[0;36m<module>\u001b[0;34m()\u001b[0m\n\u001b[1;32m      1\u001b[0m \u001b[0;31m# impoert libraries\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      2\u001b[0m \u001b[0;32mimport\u001b[0m \u001b[0mfxcmpy\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m----> 3\u001b[0;31m \u001b[0;32mimport\u001b[0m \u001b[0mtalib\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m",
